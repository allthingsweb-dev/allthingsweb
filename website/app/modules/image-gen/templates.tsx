import { toReadableDateTimeStr } from '../datetime.ts';
import { getPocketbaseUrlForImage } from '../pocketbase/api.server.ts';
import { ExpandedEvent, Speaker } from '../pocketbase/pocketbase.ts';
...
export function EventPreview(
  { event }: { event: ExpandedEvent; serverOrigin: string },
) {
  return (
    <div
    ...
    >
                ...
                >
                  <div tw='mb-2 w-40 h-40 bg-white p-2 rounded-lg overflow-hidden flex items-center justify-center'>
                    <img
                      width={160}
                      height={160}
                      src={getPocketbaseUrlForImage(sponsor.squareLogoId, {
                        width: 160,
                        height: 160,
                      })}
                      alt={sponsor.name}
      ...
      <div
        tw='flex flex-col items-center text-center'
        style={{ gap: '2rem', marginTop: '10rem' }}
      >
