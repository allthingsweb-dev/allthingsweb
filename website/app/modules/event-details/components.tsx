...
import { Avatar, AvatarFallback, AvatarImage } from '~/modules/components/ui/avatar.tsx';
import { LinkedInLogoIcon, MapPinIcon, TwitterLogoIcon } from '~/modules/components/ui/icons.tsx';
import { Alert, AlertDescription, AlertTitle } from '~/modules/components/ui/alert.tsx';
import { toReadableDateTimeStr, toWeekdayStr } from '~/modules/datetime.ts';
import { Section } from '~/modules/components/ui/section.tsx';
import { PageLayout } from '~/modules/components/page-layout.tsx';
import { deserializeExpandedEvent, Event, ExpandedTalk, Sponsor } from '~/modules/pocketbase/pocketbase.ts';
import {
  Card,
  CardContent,
  CardDescription,
...
import { ButtonNavLink } from '~/modules/components/ui/button.tsx';
import { loader } from './loader.sever.ts';
                ...
                <div className='flex items-center space-x-4 mb-2'>
                  <Avatar className='w-12 h-12'>
                    <AvatarImage
                      width={48}
                      height={48}
                      src={getImageSrc(talk.speaker.profileImageUrl, {
                        width: 48,
                        height: 48,
                      })}
          ...
          {sponsors.map((sponsor) => (
            ...
            >
              <div className='flex flex-col md:flex-row items-center space-y-6 md:space-y-0 md:space-x-8'>
                <img
                  src={getImageSrc(sponsor.squareLogo, {
                    width: 40,
                    height: 40,
                  })}
                  width={48}
