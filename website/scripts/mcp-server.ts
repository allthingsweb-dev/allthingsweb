    ...
    tools: [
          ...
          properties: {
            event: {
              ...
              properties: {
                ...
                attendeeLimit: { type: "number", description: "Maximum attendees" },
                ...
                isHackathon: { type: "boolean", description: "Is hackathon event" },
                highlightOnLandingPage: { type: "boolean", description: "Highlight on landing page" },
                fullAddress: { type: "string", description: "Full address" },
                shortLocation: { type: "string", description: "Short location name" },
                streetAddress: { type: "string", description: "Street address" },
              },
              required: ["name", "slug", "attendeeLimit", "tagline", "startDate", "endDate"],
            },
          },
          required: ["event"],
        },
          ...
          properties: {
            profile: {
              type: "object",
                 ...
                 linkedinHandle: { type: "string", description: "LinkedIn handle" },
                 twitterHandle: { type: "string", description: "Twitter handle" },
          ...
          properties: {
            talk: {
              type: "object",
                 ...
                 description: { type: "string", description: "Talk description" },
               },
      ...
      // Sponsor tools
      {
        ...
        inputSchema: {
          ...
          properties: {
            ...
            darkLogoFilePath: { type: "string", description: "Path to dark logo" },
            lightLogoFilePath: { type: "string", description: "Path to light logo" },
          },
      ...
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            ...
            imagesDir: { type: "string", description: "Images directory path (default: ./scripts/images)" },
          },
          required: ["eventSlug"],
        },
      },
      // Luma tools
      {
        ...
        inputSchema: {
          type: "object",
          properties: {
            eventId: { type: "string", description: "Luma event ID (e.g., evt-abc123)" },
          },
          required: ["eventId"],
        },
      },
...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
  ...
  try {
    switch (name) {
      ...
      case "update_profile": {
        const { name, profileData } = args as { name: string; profileData: any };
      ...
      // Talk tools
      case "create_talk": {
        const { talk, speakerIds } = args as { talk: any; speakerIds: string[] };
      ...
      case "create_sponsor": {
        ...
        const result = await createSponsor(validatedSponsor, darkLogoFilePath, lightLogoFilePath);
        return {
          content: [
            {
              type: "text",
      ...
      case "add_sponsor_to_event": {
        const { slug, sponsorName } = args as { slug: string; sponsorName: string };
      ...
      case "add_images_to_event": {
        const { eventSlug, imagesDir } = args as { eventSlug: string; imagesDir?: string };
